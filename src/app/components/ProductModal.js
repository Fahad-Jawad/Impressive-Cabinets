      ...
      >
        ...
        <div className='flex flex-col lg:flex-row gap-6 overflow-scroll productModal pb-6 lg:pb-0'>
          ...
          <div className='flex flex-col items-center lg:w-1/2'>
            <img
              src={
                `/images/products/${name}/img${selectedImageIndex}.png` ||
                `/images/products/${name}/img1.png`
              }
              alt={name}
            ...
            <div className='flex w-full '>
              {images.map((index) => (
                <img
                  key={index}
                  src={`/images/products/${name}/img${index}.png`}
          ...
          <div className='lg:w-1/2'>
            ...
            {colors.map((index) => (
                <img
                  key={index}
                  src={`/images/products/${name}/color${index}.png`}
