  ...
  return (
    <div className='bg-white rounded-lg p-4 relative'>
      ...
      <p className='text-primaryLight text-sm md:text-base'>
        ...
        tenetur quas ipsa earum sit, fugit illum asperiores! Odio explicabo aut
        quia rem praesentium magnam, impedit numquam. Delectus numquam quisquam
        quae?
      </p>
      ...
      <div className='flex w-full xl:w-1/2 items-center gap-5'>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <p className='text-sm lg:text-base text-primaryLight'>Senior Client</p>
        </div>
      </div>
      </div>
    </div>
